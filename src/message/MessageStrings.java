...
public class MessageStrings {
    ...
    public static final String PLAYER_JOINED_GAME = "%s has joined the game";
    ...
    public static final String PLAYER_WON_GAME = "%s won the game. This game is closing now. See you next time!";
    ...
    public static final String THREAD_INTERRUPTED = "Thread was interrupted during processing";
